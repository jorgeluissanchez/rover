...
export function AreaChartCo2({data}: {data: any}) {
  function calcularPorcentajeCrecimiento() {
    const n = data.length;
    if (n < 2) {
        return 0;
    }
    const ultimoValor = data[n - 1].CO2;
    const valorAnterior = data[n - 2].CO2;
  ...
  return (
    <Dialog>
      ...
      <div className="flex items-center space-x-2.5">
        <p className="text-tremor-content-strong dark:text-dark-tremor-content-strong font-medium">CO2</p>
      </div>
    ...
    />
      ...
      <DialogHeader>
        <DialogTitle>CO2</DialogTitle>
        <DialogDescription>
          This is the CO2 chart
        </DialogDescription>
      </DialogHeader>
